...
function Profile({
    ...
    return (
        <div>
            ...
            <Row>
                <Col>Email : </Col>
                <Col><input name="email" type="text" value={email} onChange={(event) => {
...
const mapDispatchToProps = (dispatch) => {
    return {
        updateUser : (userData, uid, successCallback) => dispatch(userUpdateAction(userData, uid, successCallback))
    }
}
